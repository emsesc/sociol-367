...
```         
graph_from_data_frame: This function takes a dataframe as the first input, a dataframe containing vertice data, and whether 
graph_from_edgelist: 
...
print(paste("Senate Average Shortest Path Length:", average.path.length(senate_net)))
...
print(paste("Representatives Average Shortest Path Length:", average.path.length(rep_net)))
```
