...
average_age %>%
  ...
  ggplot(aes(fill=thomas_id, x=reorder(thomas_id, -average_age), y=average_age)) +
  geom_bar(stat='identity', position='dodge') +
  scale_fill_manual("Full Committees", 
                      values=c("coral", "cyan4", "springgreen4", "steelblue", "tomato3", "burlywood1", "darkslateblue", "deeppink3", "aquamarine3", "blueviolet"), 
                      breaks = c("HSEF", "HSVR", "HSCN", "HSAS", "HSSO", "SSRA", "SSEV", "JCSE", "SCNC", "JSTX"),
                      labels=c("House Select Committee on Economic Disparity and Fairness in Growth","House Committee on Veterans' Affairs", "House Select Committee on the Climate Crisis", "House Committee on Armed Services", "House Committee on Ethics", "Senate Committee on Rules and Administration", "Senate Committee on Environment and Public Works", "Commission on Security and Cooperation in Europe", "United States Senate Caucus on International Narcotics Control", "Joint Committee on Taxation")) +
