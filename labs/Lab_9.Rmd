...
social_media_and_gender <- congress_contact %>%
  left_join(congress) %>%
  subset(type == "sen") %>%
...
```         
Research Question: Are public libraries in districts targeted by book bans in public school libraries prepared to deal with its repercussions?
```
